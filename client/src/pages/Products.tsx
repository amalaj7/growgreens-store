...
const products = [
  { name: "Live Microgreens", icon: Leaf, desc: "Fresh, nutrient-packed microgreens harvested right at your home.", worldwide: false },
  { name: "Small Farm Model", icon: Home, desc: "A complete setup including trays and seeds to start your own microgreens farm.", worldwide: true },
  { name: "Sprouts", icon: Sprout, desc: "Crisp and healthy sprouts for your daily salads and meals.", worldwide: false },
  { name: "Cashew Sprouts", icon: Nut, desc: "Delicious, protein-rich sprouted cashews for the perfect snack.", worldwide: false },
  { name: "Pulps", icon: Droplets, desc: "Pure and concentrated pulps for beverages and cooking.", worldwide: false },
  { name: "Millets", icon: Wheat, desc: "Wholesome, ancient grains that provide energy and exceptional nutrition.", worldwide: false },
  { name: "Exotic Vegetables", icon: Carrot, desc: "Rare and unique vegetables cultivated sustainably.", worldwide: false },
  { name: "Edible Flowers", icon: Flower2, desc: "Beautiful blooms that add color and flavor to any culinary creation.", worldwide: false },
  { name: "Millet Flakes", icon: Settings, desc: "Healthy flakes perfect for a nutritious breakfast or quick meal.", worldwide: false },
  { name: "Trays", icon: Box, desc: "Durable, food-grade trays designed specifically for growing microgreens.", worldwide: true },
  { name: "Seeds", icon: PackageOpen, desc: "High-quality, non-GMO seeds with great germination rates.", worldwide: true },
  { name: "Growing Medium", icon: Layers, desc: "100% decomposable, clean, and soil-less growing mediums.", worldwide: true }
];
...
export default function Products() {
  return (
    <div>
      ...
      <PageHeader 
        title="Our Products" 
        subtitle="Farm Fresh Locally & Shipped Worldwide"
      />
