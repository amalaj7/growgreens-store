...
export default function Subscription() {
  return (
    <div className="w-full bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 border-t border-gray-200">
        <h2 className="text-4xl font-bold text-center mb-3">All Available Varieties</h2>
        <p className="text-center text-gray-600 mb-12">Complete collection of microgreens you can customize in your subscription</p>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {varieties.map((variety) => (
            <div key={variety.name} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
              <div className="relative h-48 bg-gradient-to-br from-green-200 to-green-100 overflow-hidden">
                <img 
                  src={variety.image} 
                  alt={variety.name}
